 ...
 * 中國農曆算法 -用於西曆 1901 年至 2100 間的200年 
 */


public class ChineseCalendar {
	private Calendar gregorianCal;
	...
	private int chineseMonth; // 負數代表閠月
	...
	private static String[] branchNames = { "子", "丑", "寅", "卯", "辰", "巳", "午",
			"未", "申", "酉", "戌", "亥" };
	private static String[] animalNames = { "鼠", "牛", "虎", "兔", "龍", "蛇", "馬",
			"羊", "猴", "雞", "狗", "猪" };
	...
	public static void main(String[] arg) {
		...
		System.out.println(c.getChineseMonth());
		System.out.println(c.getChineseDate());
	}
	...
	public void setGregorian(Calendar cal) {
		cal.set(cal.get(Calendar.YEAR), cal.get(Calendar.MONTH), cal.get(Calendar.DATE), 0, 0, 0);
		cal.set(Calendar.MILLISECOND, 0);
		this.setGregorianCal(cal);
	...
	public String[] getYearTable() {
		...
		table[0] = getTextLine(27, "公曆年曆：" + gregorianYear);
		table[1] = getTextLine(27, "農曆年曆：" + (chineseYear + 1) + " ("
		...
		table[ln] = blank;
		ln++;
		table[ln] = getTextLine(0, "##/## - 公曆日期/農曆日期，(*)#月 - (閠)農曆月第一天");
		ln++;
		return table;
	}
	...
	private static String[] principleTermNames = { "雨水", "春分", "谷雨", "夏满",
			"夏至", "大暑", "處暑", "秋分", "霜降", "小雪", "冬至", "大寒" };
	private static String[] sectionalTermNames = { "立春", "驚蟄", "清明", "立夏",
	...
	public Calendar getGregorianCal() {
		return gregorianCal;
	}

	public void setGregorianCal(Calendar gregorianCal) {
