...
public class SBParsingService implements LogisticParsingService {
	private final static Logger log = Logger.getLogger(SBParsingService.class);
	...
	public LogisticParsingObj parseFilePattern(LogisticFormater formater) {
	    ...
	    case 8: //SSAAN021
	    	if(fileName.matches(".....(0[1-9]|1[0-9]|2[0-9]|3[0-1])[1-9]"))  {
	    		filePattern = "XXXXXddn";
	    		filePattern = fileName.substring(0,5) + "ddn" ;	
