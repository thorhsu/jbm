...
<body>
	...
	<form name="myform" id="myform" action="acctDebitNote.do" method="post">
		...
		<input type="hidden" name="fid" value="step2_addSubmit" />
		...
		<div align="center">
			<table width="95%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26" class="title">新增收費工單</td>
				</tr>
				<tr>
			...
			<table border=0 cellspacing=1 cellpadding=6 width="100%" bgcolor=#4aae66 align=left id="table76">
				...
				<td bgcolor=#f4faf3><input type="text" name="jobBagNo" /></td>		
				</tr>
			...
			<tr >
			<td colspan="6">
			(若有虛擬工單部分, 請於STEP1 產生, 此處只能新增正常工單 )
			</td>
