...
<div align="center">
	    ...
	    <input type="hidden" name="fid" value="dailyLogementReportSubmit">		
	    <table width="95%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        <td height="26" class="title">Daily Lodgement Report Query</td>
          </tr>
	      <tr>
	        <td height="15">&nbsp;</td>
          </tr>
...
<% }%>	
				...
				<TR >				
					<TD class="queryTableCellBKColor" width="10%" align="left">列出未完成交寄工單</TD>
					<TD class="queryTableCellBKColor" width="17%" align="left" >
                         <input type="checkbox" name="completedLg" value="0">是				
					</TD>
				</TR>
