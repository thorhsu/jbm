...
<div align="center">
	    <table width="95%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        <td height="26" class="title">壓封資料查詢</td>
          </tr>
	      <tr>
	        <td height="15">&nbsp;</td>
          </tr>
          <form action="psinfo.do" method="get">
          <input type="hidden" name="includeParams_value" value="psNo,custNo,pageSize" />
	      <tr>
	        <td height="30">
			...
			<TABLE border=0 cellSpacing=1 cellPadding=6 width="100%" class="queryTableBKColor" align=left id="table7">
				<TR >
					<TD class="queryTableCellBKColor" width="9%" align="left" >壓封代號</TD>
					<TD class="queryTableCellBKColor" width="12%" align="left" ><INPUT id="psNo"  maxLength=15 size=10 name="psNo" ></TD>
		 ...
		 <tr>
			...
			<TABLE border=0 cellSpacing=1 cellPadding=6 width="100%" align="center" id="table7">			
				<TR>
					...
					<TD><input name="button" type="button" onclick="location='psinfo.do?fid=addInit&backToListURL=${backToListURL}'"  id="button" value="新增" /></TD>
				</TR>
			</TABLE>
            </td>
          </tr>
	      ...
	      <tr>
			...
			<tr >
	            <vlh:header>
	            <vlh:column title="壓封代號"      property="ps_no"  sortable="desc" attributes="width=\"6%\" height=\"30\" class=\"resultTableHeaderBKColor\"  style=\"text-align:center;\""/>
	            ...
	            <vlh:column title="摺疊方式"   property="code_value_tw"  sortable="desc"  attributes="width=\"10%\" height=\"30\" class=\"resultTableHeaderBKColor\" style=\"text-align:center;\""/>
			 ...
			 <c:forEach var="bean" items="${dataList}" varStatus="stauts" >
	          <tr id="rowsCount${stauts.count}" >
	            <td height="30" ><a href="psinfo.do?fid=view&psNo=<c:out value="${bean.ps_no}" />&backToListURL=${backToListURL}"><c:out value="${bean.ps_no}" /> </a></td>
	            ...
	            <td ><a href="psinfo.do?fid=editInit&psNo=<c:out value="${bean.ps_no}" />&idList=${idList}&backToListURL=${backToListURL}"><img src="images/icon_edit.png" width="43" height="21" alt="edit" border="0"/></a></td>
	            <td ><a href="javascript:confirmDelete('psinfo.do?fid=delete&psNo=<c:out value="${bean.ps_no}"/>&backToListURL=${backToListURL}')"><img src="images/icon_delete.png" width="41" height="20" alt="edit" border="0"/></a></td>
              </tr>
              </c:forEach>
