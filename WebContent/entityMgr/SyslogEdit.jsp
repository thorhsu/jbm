...
<%  } else if (null!=actionMode &&  actionMode.equalsIgnoreCase("EDIT")   ) { %>
						...
						<input name="button6" type="button" onclick="location='returninfo.do?fid=saveAsNewInit&returnNo=<%=returninfo.getReturnNo()%>&backToListURL=${backToListURL}'"  id="button6" value="複製新增" />
